...
# 数据集路径
train_data_dir = '/home/ai_cxp/cloud-model/dataset/cloud/train_data'  # 训练数据集的文件夹路径
val_data_dir = '/home/ai_cxp/cloud-model/dataset/cloud/val_data'  # 验证数据集的文件夹路径
...
# 保存模型
torch.save(model.state_dict(), '/home/ai_cxp/cloud-model/models/cloud/cloud_recognition_model_2024-09-23.pth')
# torch.save(model.state_dict(), '../../models/cloud_recognition_model_2024-09-23.pth')
print("模型已保存为 cloud_recognition_model_2024-09-23.pth")
