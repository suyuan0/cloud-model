...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs):
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (inputs, labels) in enumerate(train_loader):
            ...
            loss = criterion(probabilities, labels)  # 计算损失
            loss.backward()  # 反向传播
            optimizer.step()  # 优化参数
        ...
        torch.save(model.state_dict(),
                   '/home/ai_cxp/cloud-model/models/flower/2024-09-26/flower_recognition_model_batch.pth')
        ...
        if val_acc >= best_val_acc:
            ...
            torch.save(model.state_dict(),
                       '/home/ai_cxp/cloud-model/models/flower/2024-09-26/flower_recognition_model.pth')
