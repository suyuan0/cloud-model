...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(),
                   '/home/ai_cxp/cloud-model/models/flower/2024-09-25/flower_recognition_model_batch.pth')
        ...
        if val_acc >= best_val_acc:
            ...
            torch.save(model.state_dict(),
                       '/home/ai_cxp/cloud-model/models/flower/2024-09-25/flower_recognition_model.pth')
