...
batch_size = 20  # 一次加载的图片数量
num_classes = 14  # 你的花朵分类任务有 14 个类别：康乃馨、鸢尾花、风铃草、金英花、玫瑰、落新妇、郁金香、金盏花、蒲公英、金鸡菊、黑眼菊、睡莲、向日葵、雏菊
epochs = 50  # 训练的周期数
...
def train_model(model, train_loader, val_loader, criterion, optimizer, epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model.state_dict(), '/home/ai_cxp/cloud-model/models/flower/flower_recognition_model_batch_2024-09-23.pth')
        ...
        if val_acc >= best_val_acc:
            ...
            torch.save(model.state_dict(),
                       '/home/ai_cxp/cloud-model/models/flower/flower_recognition_model_2024-09-23.pth')
